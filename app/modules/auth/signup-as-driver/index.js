...
class SignupAsDriver extends Component {
    componentWillMount() {
        this.props.forSignupDataClear()
    }
    onNext() {
        ...
        history.push('/signup/as-driver/first')
    }
    render() {
        return (
            <div className="modal-view">
                <div className="main-content">
                    ...
                    <div style={{display:'flex',justifyContent:'center'}}>
                        <Link className="navbar-brand logo-link1" to="/">Hup<span>van</span><span className="vsplitter"></span><span>Drivers</span></Link>
                    </div>
                        ...
                        <div className="modal-inner">
                            <form className="hupvan-form user-signin">
                                ...
                                <div className="mb-4" style={{position:'relative'}}>
                                    <DoubleRowInput name="Name" placeholder="First and last name" margin="0rem" />
                                </div>
                                ...
                                <div className="text-center login-actions" style={{marginTop:'4rem'}}>
                                    <input type="button" className="btn btn-round-primary d-block w-100" value="Sign up" onClick={()=>this.onNext()} />
